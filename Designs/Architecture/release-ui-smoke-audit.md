...
- broken sheets, popovers, file exporters, and photo picker flows
...
3. Prefer representative iPhone and iPad Simulator coverage when available.
   For iPad, treat landscape as representative layout coverage because the
   batch-image flows should remain usable in wider split-screen contexts.
4. Exercise both current primary flows when practical: resize and background
   removal.
